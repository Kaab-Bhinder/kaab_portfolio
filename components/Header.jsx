...
const Header = () => {
  return (
    <div
      className="w-full flex items-center justify-center bg-transparent px-4 sm:px-6 lg:px-8 pt-24 sm:pt-28 lg:pt-32 pb-24 sm:pb-28 lg:pb-32"
      style={{ minHeight: "80vh" }}
    >
      <div
        className="w-[90%] max-w-7xl bg-light-surface dark:bg-dark-surface rounded-2xl lg:rounded-3xl shadow-2xl flex flex-col xl:flex-row items-center xl:items-start gap-0 relative overflow-visible"
        style={{
          minHeight: "auto",
          marginTop: "16px",
          marginBottom: "16px",
      ...
      >
        {/* Mobile Profile Image - Only visible on mobile and tablet */}
        <div className="block xl:hidden w-full flex items-center justify-center pt-6 pb-4">
          <motion.div
            initial={{ scale: 0 }}
            whileInView={{ scale: 1 }}
        ...
        {/* Left Side Content */}
          <div className="flex-1 flex flex-col justify-center items-center xl:items-start px-6 sm:px-8 xl:px-20 2xl:px-24 py-8 sm:py-10 xl:py-12 z-10 relative">
            {/* Badge */}
            <div className="mb-4 sm:mb-6 flex justify-center xl:justify-start">
            ...
            {/* Heading */}
            <div className="relative w-full flex flex-row items-center justify-center xl:items-start xl:justify-start mb-4 sm:mb-6">
              <motion.h1
                initial={{ y: -30, opacity: 0 }}
                whileInView={{ y: 0, opacity: 1 }}
                transition={{ duration: 0.1, delay: 0.8 }}
                className="text-2xl sm:text-3xl xl:text-4xl 2xl:text-5xl font-bold font-Ovo text-center xl:text-left text-green-600 dark:text-green-400 leading-tight relative z-20"
                style={{ lineHeight: "1.1" }}
              >
                Hi There,
                <br />
                I'm{" "}
                <span className="text-2xl sm:text-3xl xl:text-4xl 2xl:text-5xl font-bold font-Ovo text-red-300 relative z-20">
                  Muhammad Kaab
                </span>
              </motion.h1>
            </div>
            ...
            {/* Subtext */}
            <motion.p
              className="max-w-2xl text-center xl:text-left text-gray-400 dark:text-gray-200 text-sm sm:text-base lg:text-lg mb-6 sm:mb-8 xl:mb-10"
              initial={{ opacity: 0 }}
            ...
            {/* Social Links */}
            <div className="flex justify-center xl:justify-start gap-3 sm:gap-4 mb-6 sm:mb-8">
              <a
            ...
            {/* Buttons */}
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 mb-6 sm:mb-8 w-full items-center justify-center xl:justify-start">
              <motion.a
        ...
        <div
          className="hidden xl:flex flex-1 items-center justify-center relative z-0"
